  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
      ...
      >
        ...
        {user && (
          <>
            <Link to="/add-task" className="block">Add Task</Link>
            <Link to="/my-tasks" className="block">My Tasks</Link>
            <Link to="/completed-task" className="block">Completed Task</Link>
            <Link to="/pending-task" className="block">Pending Task</Link>
          </>
        )}
